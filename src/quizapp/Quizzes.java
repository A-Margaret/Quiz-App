...
public class Quizzes extends JFrame implements ActionListener{
    ...
    Quizzes(String username) {
        this.username = username;
        setBounds(250, 50, 1440, 950);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
//        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("quizapp/images/quiz.jpg"));
        ImageIcon i1 = new ImageIcon("C:\\Users\\ELCOT\\Desktop\\labs\\practices\\QuizApp\\src\\quizapp\\images\\quiz.jpeg"); 
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 2000, 392);
        add(l1);
